...
lsp_manager.setup("golangci_lint_ls", {
  ...
  init_options = {
    command = {
      ...
      "deadcode,depguard,exhaustivestruct,gci,gofmt,interfacer,lll,maligned,misspell,nlreturn,nonamedreturns,nosnakecase,scopelint,structcheck,tagalign,tagliatelle,varcheck,whitespace,wsl",
      "--out-format",
      "json",
      "--issues-exit-code=1",
      -- "--go=1.18",
