...
**Core Standards**:
- `/Users/t.thi/dotfiles/opencode/.config/opencode/context/core/standards/code.md` → Modular, functional code patterns
- `/Users/t.thi/dotfiles/opencode/.config/opencode/context/core/standards/tests.md` → Testing requirements and TDD
- `/Users/t.thi/dotfiles/opencode/.config/opencode/context/core/standards/docs.md` → Documentation standards
- (example: `/Users/t.thi/dotfiles/opencode/.config/opencode/context/core/standards/patterns.md`) → Error handling, security patterns

**Core Workflows**:
- (example: `/Users/t.thi/dotfiles/opencode/.config/opencode/context/core/workflows/delegation.md`) → Delegation process
- (example: `/Users/t.thi/dotfiles/opencode/.config/opencode/context/core/workflows/task-breakdown.md`) → Task breakdown methodology
- (example: `/Users/t.thi/dotfiles/opencode/.config/opencode/context/core/workflows/review.md`) → Code review guidelines
