...
**Context** (`/Users/t.thi/dotfiles/opencode/.config/opencode/context/category/your-context.md`):
```yaml
---
...
```json
{
  ...
  "type": "context",
  "path": "/Users/t.thi/dotfiles/opencode/.config/opencode/context/core/workflows/session-management.md",
  "aliases": [
    "workflows-sessions",
    "sessions"
  ],
