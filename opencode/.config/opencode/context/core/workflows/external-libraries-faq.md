...
**Rule**: If it's not in `/Users/t.thi/dotfiles/opencode/.config/opencode/context/`, use ExternalScout.
...
| **Location** | `/Users/t.thi/dotfiles/opencode/.config/opencode/context/` | Internet (Context7, docs) |
