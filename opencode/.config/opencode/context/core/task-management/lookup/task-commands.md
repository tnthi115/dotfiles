...
```bash
npx ts-node /Users/t.thi/dotfiles/opencode/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/Users/t.thi/dotfiles/opencode/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
